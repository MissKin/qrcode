  ...
  <section class="showChose" v-show="showChose">
    <section class="address">
      ...
      <ul>
         ...
         <li class="addList" v-for="(v,k) in info" v-show="showProvince" @click="getProvinceId(v.id, v.name, k)" :class="v.selected ? 'active' : ''"  >{{v.name}}</li>

          <li class="addList" v-for="(v,k) in showCityList" v-show="showCity" @click="getCityId(v.id, v.name, k)"  :class="v.selected ? 'active' : ''">{{v.name}}
          </li>

          <li class="addList" v-for="(v,k) in showDistrictList" :class="v.selected ? 'active' : ''" v-show="showDistrict" @click="getDistrictId(v.id, v.name, k)" >{{v.name}}</li>
